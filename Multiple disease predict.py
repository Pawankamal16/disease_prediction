...
diabetes_model = pickle.load(open('E:/Multiple Disease Prediction System/saved_models/diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open('E:/Multiple Disease Prediction System/saved_models/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('E:/Multiple Disease Prediction System/saved_models/parkinsons_model.sav','rb'))
